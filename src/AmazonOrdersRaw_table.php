...
<div class="grid-panel">
    <div class="well well-lg">
        <div class="row">
            <table class="table" id="amazon_orders_raw_grid">
                <thead>
                <tr>
                    <th>order_id</th>
...
<!--                --><?php
//                $con = new DB_CONNECT();
//                $result = $con->getMysqli()->query("SELECT * FROM `amazon_orders_raw`");
//                if($result){
...
<script>
    $(document).ready( function () {
        $('#amazon_orders_raw_grid').DataTable( {
            scrollX: true,
            fixedHeader: true,
            processing: true,
            serverSide: true,
            ajax: "AmazonOrdersRaw_ajax.php"
        });
        $('#breadcrumb').append('<li class="breadcrumb-item active" aria-current="page">Amazon Orders Raw</li>');
    });
</script>
<?php
